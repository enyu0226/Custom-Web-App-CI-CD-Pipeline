...
# The main API resource that returns the data for all of the Mysfits to be displayed on
# the website.  The mysfits are simply stored in a static JSON file and
